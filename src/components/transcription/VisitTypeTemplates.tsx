...
const VisitTypeTemplates: React.FC<VisitTypeTemplatesProps> = ({
  ...
  return (
    <div className="space-y-4 mt-10 mr-8">
     <div className="flex justify-between items-center flex-wrap max-[400px]:flex-col max-[400px]:items-start gap-4 mb-6 bg-gradient-to-r from-[#F0F4FF] to-[#E0ECFF] rounded-xl w-full p-6 shadow-sm mb-8">
