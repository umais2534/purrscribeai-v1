...
const CallHistoryHeader = ({ onNewCall }: CallHistoryHeaderProps) => {
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center bg-gradient-to-r from-[#F0F4FF] to-[#E0ECFF] rounded-xl w-full p-6 shadow-sm mb-8">
