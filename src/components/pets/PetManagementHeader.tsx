...
const PetManagementHeader = ({ onAddPet }: PetManagementHeaderProps) => {
  return (
    <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-6 bg-gradient-to-r from-[#F0F4FF] to-[#E0ECFF] rounded-xl w-full p-6 shadow-sm gap-4">
