...
const ClinicManagement: React.FC<ClinicManagementProps> = ({ initialClinics = initialClinicsData }) => {
  ...
  return (
    <div className="bg-background p-6 rounded-lg w-full">
     <div className="flex flex-col gap-4 items-start sm:flex-row sm:justify-between sm:items-center bg-gradient-to-r from-[#F0F4FF] to-[#E0ECFF] rounded-xl w-full p-6 shadow-sm mb-8">
